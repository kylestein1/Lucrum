...
const StockInfo = ({ symbol }) => {
    ...
    // const [annIncomeData, setAnnIncomeData] = useState(null);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // const AnnIncomeResponse = await axios.get(`https://financialmodelingprep.com/api/v3/income-statement/${symbol}?apikey=7b2b04af203b96586946293f38387361`);
                // setAnnIncomeData(AnnIncomeResponse.data[0]);
            } catch (err) {
                console.error(err);
            }
        }
    ...
    return (
        <div style={styles.container}>
            ...
            {/* <h2>Annual Income Statements Data</h2> */}
            {/* <table style={styles.table}> */}
                {/* <tbody> */}
                {/* {Object.entries(annIncomeData).map(([key, value]) => ( */}
                     {/* <tr key={key} style={styles.row}> */}
                        {/* <td style={styles.cell}>{key}</td> */}
                        {/* <td style={styles.cell}>{value}</td> */}
                    {/* </tr> */}
